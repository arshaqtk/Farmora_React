...
export const View_machinery = () => {
  ...
  function loaddata() {
    axios
      .post("/view_machinery", { ofid: sessionStorage.getItem("oid") })
      .then((response) => {
  ...
  function delete_machinery(machineryid) {
    Swal.fire({
      title: "Are you sure?",
      ...
      if (result.isConfirmed) {
        axios
          .post("/Officer_delete_machinery", { machinery_id: machineryid })
          .then(() => {
            Swal.fire({
              title: "Deleted!",
              text: "Machinery has been deleted.",
              icon: "success",
              confirmButtonColor: "#28A745",
            });
            loaddata(); // Reload data dynamically
          })
          .catch((error) => console.log(error.response || error));
      }
    });
  ...
  return (
    <div>
      <NavBar></NavBar>
      <div
      style={{ backgroundColor: "#f8f8e8", padding: "20px", minHeight: "100vh" ,marginTop: "70px",}}
    >
      <h2
      ...
      >
        <thead>
          ...
          >
            ...
            <th style={{ padding: "10px", textAlign: "center" }}>Edit/Delete</th>
          </tr>
        </thead>
        <tbody>
          {result.map((s, index) => (
              ...
              <td style={{ padding: "10px" }}>
                <div className="d-flex gap-2">
                  <button
                    ...
                    onClick={() => delete_machinery(s._id)}
                  >
                    Delete
                  </button>
                  <button
                  ...
                  >
                    <a
                      href={`/Farm_officer_Update_machinery/${s._id}`}
          ...
          <tr>
            <td colSpan="8" style={{ padding: 10, textAlign: "center" }}>
              ...
              >
                <a
                  href="/Farm_officer_Add_machinery"
                  style={{ textDecoration: "none", color: "white" }}
                >
                  ADD
                </a>
