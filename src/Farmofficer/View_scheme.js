...
export const View_scheme = () => {
  ...
  function loaddata() {
    axios
      .post("/view_scheme", { ofid: sessionStorage.getItem("oid") })
      .then((response) => {
  ...
  function delete_scheme(schid) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .post("/Officer_delete_scheme", { scheme_id: schid })
          .then(() => {
            Swal.fire({
              title: "Deleted!",
      ...
      >
        <thead>
          ...
          >
            ...
            <th style={{ padding: "10px" }}>Scheme Title</th>
        ...
        <tbody>
          {result.map((s, index) => (
            ...
            >
              ...
              <td style={{ padding: "10px" }}>{s.eligibilty}</td>
              <td style={{ padding: "10px" }}>{s.link}</td>
              <td>
                <img
                                  alt="Schme Image"
                                  style={{
              ...
              <td style={{ padding: "10px" }}>
                <div className="d-flex gap-2">
                  ...
                  >
                    <a
                      href={`/Farm_officer_Update_scheme/${s._id}`}
